...
public class BeeperManager : IBeeperEngine
{
    ...
    public static Dictionary<string, int> notes = new();
    public static Dictionary<string, int> noteLengths = new();
    public static PersistentBeeper GlobalBeeper = new PersistentBeeper();
    public BeeperManager()
	{
        ...
        var noteLengths = new Dictionary<string, int>
        {
            { "whole", 2000 },     // 4 beats
            { "half", 1000 },      // 2 beats
            { "quarter", 500 },    // 1 beat
    ...
    public static void Beeper(int frequency, int durationMs)
    {
        GlobalBeeper.PlayNote(frequency, durationMs, WaveformType.Sine);
    }
    public static void Beeper(int frequency, int durationMs, WaveformType type)
    {
        GlobalBeeper.PlayNote(frequency, durationMs, type);
    }
